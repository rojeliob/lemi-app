...
<template>
  <div class="flex min-h-screen bg-gray-100">
    <!-- Sidebar -->
    <aside class="w-64 bg-white dark: bg-violet-900">
          ...
          >
            ...
            <defs>
              ...
              >
                ...
                <stop offset="0.524476" stop-color="#6A44C4" />
                <stop offset="1" stop-color="#6A44C4" />
              </linearGradient>
              <linearGradient
      ...
      <div class="absolute border-t border-gray-200 dark:border-gray-700">
        <div class="p-4">
          <!-- Settings Dropdown -->
